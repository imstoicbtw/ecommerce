...
export function SuccessfulPayments () {
    ...
    const { data: payments, isLoading: paymentsLoading, error: paymentsError, refetch: refechPayments } = useGetPaymentsByStatusQuery({ ...params, size: pageSize, status: "completed" }, { refetchOnMountOrArgChange: true });
        ...
        <main>
            ...
            {!payments?.data?.length
                ...
                : <>
                    ...
                    <Pagination meta={payments.meta} baseUrl={"/dashboard/payments/successful"} pageSize={pageSize} setPageSize={setPageSize} />
                </>
            }
        </main>
    );
