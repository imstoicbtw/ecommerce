...
export function DeliveredOrders () {
    ...
    const { data: orders, isLoading: loadingOrders, error: ordersError, refetch: refetchOrders } = useGetOrdersByStatusQuery({ ...params, size: pageSize, status: "delivered" }, { refetchOnMountOrArgChange: true });
        ...
        <main>
            ...
            {!orders?.data?.length
                ...
                : <>
                    ...
                    <Pagination meta={orders.meta} baseUrl={"/dashboard/orders/delivered"} pageSize={pageSize} setPageSize={setPageSize} />
                </>
            }
        </main>
    );
