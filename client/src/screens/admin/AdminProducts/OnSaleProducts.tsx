...
export function OnSaleProducts () {
    ...
    const { data: products, isLoading: loadingProducts, error: productsError, refetch: refetchProducts } = useGetProductsOnSaleQuery({ ...params, size: pageSize }, { refetchOnMountOrArgChange: true });
