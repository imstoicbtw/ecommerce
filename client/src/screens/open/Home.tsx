        ...
        <main>
            <section className={"inner mt-3"}>
                <div className={"text-white shadow-2xl min-h-64 bg-[url(stars.gif)] bg-black rounded-3xl flex flex-col justify-center items-center py-20"}>
                    <h2 className={"text-8xl leading-none font-black opacity-90 blur-xs tracking-widest text-blue-200 uppercase"}>
                        Happy Diwali
                    </h2>
            ...
            <section className={"inner mt-30"}>
                <h3 className={"text-3xl font-bold mb-10 uppercase tracking-widest text-green-600 text-center flex flex-col items-center gap-2 w-max mx-auto"}>
            ...
            <section className={"inner mt-30"}>
                <h3 className={"text-3xl font-bold mb-10 uppercase tracking-widest text-blue-600 text-center flex flex-col items-center gap-2 w-max mx-auto"}>
            ...
            <section className={"inner mt-30"}>
                <h3 className={"text-2xl font-bold mb-10 uppercase tracking-widest text-slate-700 text-center flex flex-col items-center gap-2 w-max mx-auto"}>
            ...
            <section className={"inner my-30"}>
                <div className={"bg-blue-50 border-2 border-blue-100 p-10 rounded-3xl shadow-2xl flex flex-col sm:flex-row gap-5 items-center justify-between"}>
